...
class CheckMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, coin: str, user: str,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> int:
        """Execute underlying contract method via eth_call.
...
class OraclePostResultMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, _round: int, dot: int, _hash: str, total_users: int,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class RoundVaultMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, index_0: int,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> Tuple[int, int, str]:
        """Execute underlying contract method via eth_call.
...
class SetDiscountMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, user: str, perc: int,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class SetFeeMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, x: str, percent_1000: int,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class SetRoundMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, n_round: int,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class TakeUsrMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, user: str, coin: str, amount: int,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class UpBankVaultMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, coins: List[str], balances: List[int],_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class UpUsrBatchMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, users: List[str], coins: List[str], amounts: List[int],_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class UpdateProviderMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, k: str,_gaswei:int,_pricewei:int,_valeth:int=0,_debugtx: bool = False,_receipList: bool = False) -> None:
        """Execute underlying contract method via eth_call.
...
class Enrockvault(ContractBase):
    ...
    def __init__(
        ...
        signed = SignatureGenerator(Enrockvault.abi())
    ...
    def donate_erc20(self, coin: str, amount: int) -> None:
        ...
        return self._fn_donate_erc20.block_send(coin, amount, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def oracle_post_result(self, _round: int, dot: int, _hash: str, total_users: int) -> None:
        ...
        return self._fn_oracle_post_result.block_send(_round, dot, _hash, total_users, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def set_discount(self, user: str, perc: int) -> None:
        ...
        return self._fn_set_discount.block_send(user, perc, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def set_fee(self, x: str, percent_1000: int) -> None:
        ...
        return self._fn_set_fee.block_send(x, percent_1000, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def set_round(self, n_round: int) -> None:
        ...
        return self._fn_set_round.block_send(n_round, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def take_usr(self, user: str, coin: str, amount: int) -> None:
        ...
        return self._fn_take_usr.block_send(user, coin, amount, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def up_bank_vault(self, coins: List[str], balances: List[int]) -> None:
        ...
        return self._fn_up_bank_vault.block_send(coins, balances, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def up_single(self, user: str, coin: str, amount: int) -> None:
        ...
        return self._fn_up_single.block_send(user, coin, amount, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def up_usr_batch(self, users: List[str], coins: List[str], amounts: List[int]) -> None:
        ...
        return self._fn_up_usr_batch.block_send(users, coins, amounts, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
    ...
    def update_provider(self, k: str) -> None:
        ...
        return self._fn_update_provider.block_send(k, self.call_contract_fee_amount,self.call_contract_fee_price,0,self.call_contract_debug_flag, self.call_contract_enforce_tx_receipt)
